    ...
    function add_address(){
        if($.sValid()){
            ...
            $.ajax({
                ...
                data:{key:key,true_name:true_name,mob_phone:mob_phone,tel_phone:tel_phone,city_id:city_id,area_id:area_id,address:address,area_info:area_info,is_default:is_default},
                dataType:'json',
                success:function(result){
                    if(result){
