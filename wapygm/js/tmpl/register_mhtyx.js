MYAPP.ready(function(){
	...
	$('#reg').click(function(){	
		...
		$.ajax({
			type:'post',
			url:ApiUrl+"/index.php?act=register&op=mhtyx",	
			data:{mobile:mobile,verify:verify,password:password,repassword:repassword,share_mid:share_mid},
			dataType:'json',
			success:function(result){
				if(!result.datas.error){					
					$.sDialog({
	                    ...
	                    cancelBtn: false,
	                    okFn:function() {
	                    	MYAPP.gopage({'url':'http://a.app.qq.com/o/simple.jsp?pkgname=com.moyun.mhtyx'});
	                    }
	                  });
