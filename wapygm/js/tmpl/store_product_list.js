MYAPP.ready(function(){
	...
	if (!store_id) {
		store_id = 1; //url请求无store_id时 默认为1
	};
    ...
    if($("input[name=store_id]").val()!=''){
    	$.ajax({
    		url:ApiUrl+"/index.php?act=store_goods&op=goods_list&key=4&page="+pagesize+"&curpage=1"+'&store_id='+$("input[name=store_id]").val(),
    		type:'get',
    		dataType:'json',
    	...
    	$.ajax({
    		url:ApiUrl+"/index.php?act=store_goods&op=goods_list&key=4&page="+pagesize+"&curpage=1"+'&keyword='+$("input[name=keyword]").val(),
    		type:'get',
    		dataType:'json',
    		success:function(result){
    			$("input[name=hasmore]").val(result.hasmore);
    ...
    $("select[name=page_list]").change(function(){
    	...
    	if(store_id>0){
    		var url = ApiUrl+"/index.php?act=store_goods&op=goods_list&key="+key+"&order="+order+"&page="+page+"&curpage="+curpage+"&store_id="+store_id;
    	}else{
    		var url = ApiUrl+"/index.php?act=store_goods&op=goods_list&key="+key+"&order="+order+"&page="+page+"&curpage="+curpage+"&keyword="+keyword;
    	}
	...
	$('.keyorder').click(function(){
		...
		if(store_id>0){
			var url = ApiUrl+"/index.php?act=store_goods&op=goods_list&key="+curkey+"&order="+curorder+"&page="+page+"&curpage=1&store_id="+store_id;
		}else{
			var url = ApiUrl+"/index.php?act=store_goods&op=goods_list&key="+curkey+"&order="+curorder+"&page="+page+"&curpage=1&keyword="+keyword;
		}
