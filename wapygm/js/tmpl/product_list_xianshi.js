MYAPP.ready(function(){
    ...
    if($("input[name=gc_id]").val()!=''){
    	$.ajax({
    		url:ApiUrl+"/index.php?act=goods&op=goods_list_xianshi&key=1&order=2&page="+pagesize+"&curpage=1"+'&gc_id='+$("input[name=gc_id]").val(),
    		type:'get',
    		dataType:'json',
    	...
    	$.ajax({
    		url:ApiUrl+"/index.php?act=goods&op=goods_list_xianshi&key=1&order=2&page="+pagesize+"&curpage=1"+'&store_id='+store_id+'&stc_id='+stc_id+'&keyword='+keyword+'&comId='+comId+'&brand_id='+brand_id,
    		type:'get',
    		dataType:'json',
    		success:function(result){
    	 ...
    	 $(window).scroll(function(){
    		...
    		//console.log("总页数:"+pages+"===当前页"+curpage);
	            if(($(window).scrollTop() + $(window).height() > $(document).height()-40) && !ajax && pages > curpage){
	                ...
	                if(gc_id>=0){
	        			var url = ApiUrl+"/index.php?act=goods&op=goods_list_xianshi&key="+key+"&order="+order+"&page="+page+"&curpage="+curpage+"&gc_id="+gc_id;
	        		}else{
	        			var url = ApiUrl+"/index.php?act=goods&op=goods_list_xianshi&key="+key+"&order="+order+"&page="+page+"&curpage="+curpage+"&keyword="+keyword+'&store_id='+store_id+'&stc_id='+stc_id+'&comId='+comId+'&brand_id='+brand_id;
	        		}
	...
	$('.product-order').click(function(){
		...
		if(gc_id>0){
			var url = ApiUrl+"/index.php?act=goods&op=goods_list_xianshi&key="+curkey+"&order="+curorder+"&page="+page+"&curpage=1&gc_id="+gc_id;
		}else{
			var url = ApiUrl+"/index.php?act=goods&op=goods_list_xianshi&key="+curkey+"&order="+curorder+"&page="+page+"&curpage=1&keyword="+keyword+'&store_id='+store_id+'&stc_id='+stc_id+'&comId='+comId+'&brand_id='+brand_id;
		}
